namespace Web.Gateway.Dto.Response.Product
{
    public class ProductItemResponse
    {
        ...
        public ProductContactPerson? ProductContactPerson { get; set; }
        public ProductUserSubscription? ProductUserSubscription { get; set; }
    }
    ...
    public class ProductContactPerson
    {
    ...
    public class ProductUserSubscription
    {
